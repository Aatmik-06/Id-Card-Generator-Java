<%-- 
    Document   : add_Id_Card
    Created on : 28 Feb 2025, 11:23:56 pm
    Author     : adi18
--%>
...
<html>
    <head>
       ...
       <title>TechCorp ID Management</title>
    ...
    <main class="main-content">
        ...
        <div class="card-grid">
            <div class="form-container">
                <form id="idCardForm" action="dashBoard_Add_Id_Card.jsp">
                  <div class="form-grid">
      
                      <div class="form-group">
                          <label for="empid">Employee ID</label>
                          <input name="empid" type="text" id="fullName" required>
                        </div>  
