<%-- 
    Document   : searchByIdController
    Created on : 1 Mar 2025, 11:20:41 pm
    Author     : adi18
--%>
...
<html>
        ...
        <main class="main-content">
            ...
            <div class="container">
                <%
                    ...
                    if (idb.getPhotoUrl() != null) {
                        out.println("<h1><font color='blue'>Employee Found</font></h1>");
 ...
 out.println("<h1><font color='red'>Employee Not Found</font></h1>");
